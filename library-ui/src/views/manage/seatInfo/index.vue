  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="seatInfoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="编号" align="center" v-if="columns[0].visible" prop="id" />
        ...
        <el-table-column label="描述" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="description" />
...
<script>
import { listSeatInfo, getSeatInfo, delSeatInfo, addSeatInfo, updateSeatInfo } from "@/api/manage/seatInfo";
